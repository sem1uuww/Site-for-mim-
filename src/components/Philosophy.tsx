      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
        ...
        <div className="flex flex-col justify-center">
          <motion.h3 
            ...
            viewport={{ once: true }}
            className="text-sm uppercase tracking-[0.4em] font-bold text-luxury-gold mb-8 md:mb-12"
          >
            Философия и видение
          </motion.h3>
          ...
          >
            <p className="font-serif italic text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.2] text-luxury-charcoal mb-8 md:mb-12">
